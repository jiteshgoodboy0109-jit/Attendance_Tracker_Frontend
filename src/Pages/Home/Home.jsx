...
function Home({
  ...
  const getElapsedHoursMinsStr = (s) =>
  ...
  return (
    <>
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-5 items-start animate-fade-in select-none">
    ...
    bg-white dark:bg-[#0D1117]  dark:border-[#30363D]"
          >
            <div
              className={`absolute top-0 right-0 w-32 h-32 rounded-full blur-3xl pointer-events-none transition-all duration-700 group-hover:scale-125
                    ${
                      {
                        not_checked_in:
                          "bg-purple-600/[0.04] dark:bg-purple-600/5",
                        working: "bg-emerald-600/[0.04] dark:bg-emerald-600/5",
                        done: "bg-blue-600/[0.04] dark:bg-blue-600/5",
                      }[checkInStatus]
                    }
                `}
            />
            ...
            <div className="flex justify-between items-start z-10">
              ...
              <div>
                {() => {
                  ...
                  return (
                    <span
                      className={`px-3 py-1.5 rounded-full border text-[9px] font-black uppercase tracking-wider flex items-center gap-1.5 shadow-sm ${badge.cls}`}
                    >
                      <span
