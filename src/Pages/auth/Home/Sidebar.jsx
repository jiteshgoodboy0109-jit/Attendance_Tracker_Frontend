...
function Sidebar({ isDark, setIsDark, activeMenu, setActiveMenu }) {
  return (
    <aside className="w-64 flex-shrink-0 flex flex-col border-r transition-colors duration-300 
      ...
      {/* Brand Logo Header */}
      <div className="h-16 px-6 flex items-center gap-3 border-b border-slate-200 dark:border-slate-800/60">
      ...
      <div className="flex-1 px-4 py-6 space-y-7 overflow-y-auto">
        ...
        <div className="space-y-1.5">
          ...
          {[
            ...
            { name: 'Attendance', icon: FiUserCheck },
            ...
            return (
              <button
                ...
                className={`w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 group
                  ${isActive 
                    ? 'bg-slate-100 dark:bg-[#111625] text-[#bf40bf] dark:text-purple-400 shadow-sm' 
      ...
      <div className="p-4 border-t border-slate-200 dark:border-slate-800/60 space-y-4">
        ...
        <div className="relative overflow-hidden rounded-2xl p-4 bg-gradient-to-br from-[#1C162E] to-[#0A0713] border border-indigo-900/30 shadow-md">
          {/* Decorative radial blur gradient overlay */}
